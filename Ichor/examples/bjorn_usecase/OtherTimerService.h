...
struct IOtherTimerService : virtual public IService {
};

class OtherTimerService final : public IOtherTimerService, public Service<OtherTimerService> {
public:
    OtherTimerService(DependencyRegister &reg, IchorProperties props, DependencyManager *mng) : Service(std::move(props), mng) {
