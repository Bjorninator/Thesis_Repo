...
struct ICalculationService : virtual public IService {
};

class CalculationService final : public ICalculationService, public Service<CalculationService> {
public:
    CalculationService(DependencyRegister &reg, IchorProperties props, DependencyManager *mng) : Service(std::move(props), mng) {
